...
footer: 'Aespi Botz --|> 2022', 
buttonText: "Klick Ini Kak", 
sections,
mentions:[m.sender]
}, { quoted : fgi })
sock.sendMessage(m.chat, { audio: { url: './worker/Mengkane.mp3' }, mimetype: 'audio/mp4' }, { quoted: ftroli })
}
break
case prefix+'thunder':{
...
case prefix+'ytmp3': case prefix+'ytaudio': {
            ...
            case prefix+'ytmp4': case prefix+'ytvideo': {
                ...
                if (media.filesize >= 300000) return ads('File Melebihi Batas '+util.format(media))
